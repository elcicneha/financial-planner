...
export default function VariantCAS() {
  const { data, loading, error, refetch } = useCASCapitalGains();
      ...
      <div className="flex h-[80vh] items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>
              Capital Account Statement data not found
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground">
              The capital gain loss statement JSON file is required to display CAS data.
            </p>
          </CardContent>
        </Card>
      </div>
